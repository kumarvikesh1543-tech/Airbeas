---
name: Bug Report
about: Report a bug found in AirBeats to help us improve the application
title: "[BUG] Brief description of the issue"
labels: bug
assignees: darkxvenom
---
...
```
**How to capture logs:**
- Use `adb logcat | grep -i AirBeats` for filtered logs
...
- [ ] I have tested on the latest version of AirBeats
